...
const Footer = () => {
  return (
    <footer className="bg-zinc-900 mt-20  text-white py-4">
      <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
        <div className="text-center md:text-left">
          <h2 className="text-xl font-bold">Turbo Tests</h2>
          <p className="mt-1">Best Fast Food in Town</p>
        </div>
        ...
        <div className="mt-4 md:mt-0 text-center">
          <p>&copy; 2024 Fast Food Co. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
